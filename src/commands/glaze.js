...
export default async function glaze(interaction, client) {
  ...
  const prompt = `Write a few sentences long (brief), over-the-top praise message for a person named "${tag}". Use a **different and wildly unique writing style or format** (e.g. Shakespearean sonnet, pirate talk, Gen Z slang, formal royal decree, rap verse, fantasy prophecy, anime monologue, haiku, etc). Be unpredictable and over-the-top.`;
